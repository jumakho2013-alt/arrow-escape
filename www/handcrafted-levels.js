...
const HANDCRAFTED_LEVELS = {
  ...
  // ─────────────────────────────────────────────────────────────────
  // LEVEL 30 — "Arrow" milestone — meta arrow shape (right-pointing)
  // ─────────────────────────────────────────────────────────────────
  30: {
    cols: 13, rows: 11,
    arrows: [
      // Tip of arrow (rightmost)
      { c: [[5,11]], d: 0 },
      // Upper diagonal of tip
      { c: [[3,9],[4,9]], d: 0 },
      { c: [[4,10]], d: 0 },
      { c: [[2,8],[3,8]], d: 0 },
      { c: [[1,7],[2,7]], d: 0 },
      // Lower diagonal of tip
      { c: [[7,9],[6,9]], d: 0 },
      { c: [[6,10]], d: 0 },
      { c: [[8,8],[7,8]], d: 0 },
      { c: [[9,7],[8,7]], d: 0 },
      // Shaft (long horizontal)
      { c: [[5,1],[5,2],[5,3],[5,4],[5,5],[5,6],[5,7],[5,8],[5,9],[5,10]], d: 0 },
    ]
  },

  // ─────────────────────────────────────────────────────────────────
  // LEVEL 70 — "Tree" milestone
  // Pine tree silhouette with trunk.
  // ─────────────────────────────────────────────────────────────────
  70: {
    cols: 13, rows: 13,
    arrows: [
      // Top of tree (small triangle)
      { c: [[1,6]], d: 1 },
      { c: [[2,5],[2,6],[2,7]], d: 0 },
      // Middle layer
      { c: [[4,4],[4,5],[4,6],[4,7],[4,8]], d: 0 },
      { c: [[5,3]], d: 0 },
      { c: [[5,9]], d: 0 },
      // Wide bottom layer
      { c: [[6,3],[6,4],[6,5],[6,6],[6,7],[6,8],[6,9]], d: 0 },
      { c: [[7,2]], d: 0 },
      { c: [[7,10]], d: 0 },
      // Trunk
      { c: [[10,6],[9,6],[8,6]], d: 1 },
